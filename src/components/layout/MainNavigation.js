            ...
            <nav className="flex items-center justify-between bg-white px-40 py-2 shadow border-b-2 h-14">
                ...
                <ul className="flex mr-6 mt-2 items-center">
                    <li className="flex mr-6">
                        <Link  to='/' className="no-underline  text-lg hover:text-blue-500 text-gray-700  ">Home</Link>
                    </li>
                    <li className="flex mr-6">
                        <Link to='/about' className="no-underline text-gray-700 hover:text-blue-500 text-lg ">About</Link>
                    </li>
                </ul>
